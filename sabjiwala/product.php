...
?>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">vendor's/Shop Name
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">VENDORS: </h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<?php
										$area = $_SESSION['area'];
										$result = mysqli_query($con, "SELECT * FROM fregistration WHERE area='$area' ORDER BY id DESC");
									...
									<div class="info-product-price">
										<span class="item_price">Address: <?php echo $row['area']; ?></span><br>
										<!-- <del>$280.00</del> -->
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
											<a class="btn btn-primary" href="index.php?id=<?php echo $row['id']; ?>">View Stock by <?php echo $row['name']; ?></a>
									</div>
